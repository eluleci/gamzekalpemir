...
var MainController = React.createClass({
  ...
  render: function () {
    ...
    if (post.platform == "twitter") {
      return React.createElement(TwitterItem, { post: this.state.posts[this.state.currentIndex] });
    } else if (post.platform == "instagram") {
      return React.createElement(InstagramItem, { post: this.state.posts[this.state.currentIndex] });
    }
  },
...
React.render(React.createElement(MainController, null), document.getElementById('container'));